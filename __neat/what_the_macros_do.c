...
# 158 "src/rendering/rendering.c"
        ...
        mat4x4 view_matrix = Transform_matrix(((Transform *) _get_aspect_type(( camera )->entity_id, Transform_TYPE_ID)));
...
# 163 "src/rendering/rendering.c"
            ...
            mat4x4 model_matrix = Transform_matrix(((Transform *) _get_aspect_type(( body )->entity_id, Transform_TYPE_ID)));
