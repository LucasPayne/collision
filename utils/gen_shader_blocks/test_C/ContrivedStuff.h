...
typedef struct ContrivedStuff_Stuff_s { //size: 76
...
} ContrivedStuff_Stuff;
typedef struct ContrivedStuff_OtherStuff_s { //size: 156
...
} ContrivedStuff_OtherStuff;

ShaderBlockID ShaderBlockID_ContrivedStuff;
typedef struct ShaderBlockStruct_ContrivedStuff_s {
    bool ays[1000];    //offset: 0, alignment: 16, C_type_size: 16000
    Stuff things[1000];    //offset: 16000, alignment: 16, C_type_size: 80000
...
} ShaderBlockStruct_ContrivedStuff;
